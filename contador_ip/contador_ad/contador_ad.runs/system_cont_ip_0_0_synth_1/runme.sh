...
HD_PWD='/home/nicolas/Documentos/FPGA_Practicas/contador_ip/contador_ad/contador_ad.runs/system_cont_ip_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_cont_ip_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_cont_ip_0_0.tcl
