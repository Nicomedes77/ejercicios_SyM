...
HD_PWD='/home/nicolas/Documentos/FPGA_Practicas/sumador_ip/sumador_ip/sumador_ip.runs/system_sum_ip_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_sum_ip_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_sum_ip_0_0.tcl
